...
with patch.object(registry, "get_collector", return_value=collector), patch.object(graph_client, "GraphClient", return_value=object()), patch.object(tasks.evaluate_control, "delay", execute_serialized):
