...
from app.services.encryption import InvalidToken, decrypt, unreadable_credential
...
async def get_scan_readiness(
    ...
    try:
        ...
        # Readiness is the endpoint a user hits before starting a scan, so it is
        # the first place a botched key rotation surfaces. Answering 409 here
        # tells them why; an unhandled InvalidToken answered 500.
        raise unreadable_credential("m365_connection.encrypted_client_secret") from None
