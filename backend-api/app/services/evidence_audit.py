...
# Declared in the model's vocabulary since Phase 7 and emitted by nothing until
# Phase 10 gave legal hold an API and retention a report.
ACTION_RETENTION_EXPIRED = "retention_expired"
ACTION_LEGAL_HOLD_APPLIED = "legal_hold_applied"
ACTION_LEGAL_HOLD_RELEASED = "legal_hold_released"
ACTION_AUDIT_READ = "audit_read"
