...
AUDIT_ACTIONS = (
    ...
    "legal_hold_applied",
    "legal_hold_released",
    # Phase 10: reading the access log is itself an access decision, and an
    # auditor must be able to see that another auditor looked. Its own action
    # rather than reusing "downloaded", which would make every "who downloaded
    # this evidence" query wrong.
    "audit_read",
)
